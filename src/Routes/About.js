            ...
            <div className="flex justify-center items-center flex-col mt-8">
              <Fade right cascade>
                ...
                <p className="mt-4 text-gray-200 text-lg text-left p-2 md:p-4">
                  ...
                  praesentium, quia modi, quis ipsum explicabo quibusdam, odio
                  amet voluptate et eos numquam odit asperiores obcaecati
                  pariatur repudiandae accusantium porro delectus est animi
                  iure. Culpa obcaecati ex quia consequatur similique ipsum
                  dolore cupiditate reprehenderit accusantium deserunt laborum
                  sit vel, incidunt quidem.
                </p>
              </Fade>
            </div>
          </div>
